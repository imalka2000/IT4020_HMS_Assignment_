...
public class PharmacyController {
    @Autowired private PharmacyService svc;
    @GetMapping @Operation(summary="Get all medicines")
    public ResponseEntity<List<Medicine>> getAll() { return ResponseEntity.ok(svc.getAll()); }
    @GetMapping("/{id}") @Operation(summary="Get medicine by ID")
    ...
    @PostMapping @Operation(summary="Add medicine")
    ...
    @PutMapping("/{id}") @Operation(summary="Update medicine")
    ...
    @PatchMapping("/{id}/stock") @Operation(summary="Update stock")
