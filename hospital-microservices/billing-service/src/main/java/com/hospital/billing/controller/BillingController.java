...
public class BillingController {
    @Autowired private BillingService svc;
    @GetMapping @Operation(summary="Get all invoices")
    public ResponseEntity<List<Invoice>> getAll() { return ResponseEntity.ok(svc.getAll()); }
    @GetMapping("/{id}") @Operation(summary="Get invoice by ID")
